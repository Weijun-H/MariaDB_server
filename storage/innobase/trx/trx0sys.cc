...
inline void rw_trx_hash_t::create(ulint n)
{
  n_cells= ut_find_prime(n);
  const size_t size= ut_calc_align<size_t>(pad(n_cells) * sizeof *array,
...
void trx_sys_t::close()
{
  ...
  rw_trx_hash.for_each([](trx_t &trx)
  {
